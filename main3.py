...
qdrant = QdrantClient(url=keys.QDRANT_URL, api_key=keys.QDRANT_API_KEY)
...
async def ask_vapi(request: Request):
    try:
        ...
        if not question.strip():
            ...
            return {
                "results": [{
                    ...
                    "result": "Please provide a question about our car inventory"
                }]
            }
        ...
        if not context.strip():
            final_answer = "I couldn't find any matching cars in our inventory."
        else:
            llm_response = client.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "You are a helpful car inventory assistant."
                    },
                    {
                        "role": "user", 
                        "content": f"Context:\n{context}\n\nQuestion:\n{question}"
